...
class Net(nn.Module):
    ...
    def forward(self, img):
        ...
        indices = (
            inidices_positive.view(-1).data * pixel_count + pixel_range
        ).squeeze()
        ...
        indices = (
            inidices_negative.view(-1).data * pixel_count + pixel_range
        ).squeeze()
...
if __name__ == "__main__":
    img = imread("/home/syzygianinfern0/Pictures/black_panther.jpg") / 255.0
