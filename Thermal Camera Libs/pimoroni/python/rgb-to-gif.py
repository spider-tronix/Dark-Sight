...
parser.add_argument(
    "--frames", type=int, help="Number of frames to capture.", default=MAX_FRAMES
)
parser.add_argument(
    "--fps",
    type=int,
    help="Framerate to capture. Default: 4",
    choices=[1, 2, 4, 8, 16, 32, 64],
    default=FPS,
)
parser.add_argument(
    "--skip", type=int, help="Frames to skip. Default: 2", default=SKIP_FRAMES
)
...
print(
    """rgb-to-gif.py - output a gif using ./rawrgb command.
